...
class UserAuthenticator(Base):
    ...
    transports = Column(Text, nullable=True) # JSON list of strings
    
    # E2EE wrapping
    encrypted_dek_prf = Column(Text, nullable=True)
    dek_iv_prf = Column(String, nullable=True)
